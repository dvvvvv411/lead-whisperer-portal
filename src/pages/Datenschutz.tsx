...
const Datenschutz = () => {
  return (
    <PageLayout
      ...
      description="Informationen gemäß DSGVO"
    >
      <div className="prose prose-invert max-w-none">
        <section className="bg-casino-card border border-gold/20 p-6 rounded-lg shadow-lg mb-8">
          <h2 className="text-xl font-bold mb-4 text-gold">1. Datenschutz auf einen Blick</h2>
          
          <h3 className="text-lg font-semibold mt-6 mb-2">Allgemeine Hinweise</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">Datenerfassung auf dieser Website</h3>
          <h4 className="text-base font-semibold mt-4 mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
          <p>
            Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem 
            Abschnitt „Hinweis zur Verantwortlichen Stelle" in dieser Datenschutzerklärung entnehmen.
          </p>

          <h4 className="text-base font-semibold mt-4 mb-2">Wie erfassen wir Ihre Daten?</h4>
          <p>
          ...
          <h4 className="text-base font-semibold mt-4 mb-2">Wofür nutzen wir Ihre Daten?</h4>
          <p>
          ...
          <h4 className="text-base font-semibold mt-4 mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
          <p>
        ...
        <section className="bg-casino-card border border-gold/20 p-6 rounded-lg shadow-lg mb-8">
          <h2 className="text-xl font-bold mb-4 text-gold">2. Hosting</h2>
          
          <p>
            Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-2">Externes Hosting</h3>
          <p>
        ...
        <section className="bg-casino-card border border-gold/20 p-6 rounded-lg shadow-lg mb-8">
          <h2 className="text-xl font-bold mb-4 text-gold">3. Allgemeine Hinweise und Pflicht­informationen</h2>
          
          <h3 className="text-lg font-semibold mt-6 mb-2">Datenschutz</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">Hinweis zur verantwortlichen Stelle</h3>
          <p>
        ...
        <section className="bg-casino-card border border-gold/20 p-6 rounded-lg shadow-lg mb-8">
          <h2 className="text-xl font-bold mb-4 text-gold">4. Datenerfassung auf dieser Website</h2>
          ...
          <p>
            ...
            gelöscht. Permanente Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst löschen oder eine automatische 
            Löschung durch Ihren Webbrowser erfolgt.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-2">Kontaktformular</h3>
          <p>
