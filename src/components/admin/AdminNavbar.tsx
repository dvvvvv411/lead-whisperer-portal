...
import { LayoutDashboard, Users, FileText, Wallet, CreditCard, ArrowUpRight, Menu, Info, Bitcoin, UserPlus, DollarSign } from "lucide-react";
  ...
  return <div className="w-full border-b border-gold/10 mb-6 bg-casino-darker/80 backdrop-blur-lg sticky top-0 z-50">
      <div className="container mx-auto">
        <Menubar className="py-3 px-4 w-full bg-transparent border-none">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="hidden md:flex space-x-1">
              ...
              <NavItem to="/admin/total-payouts" icon={<DollarSign className="w-4 h-4 mr-2" />} label="Gesamtauszahlungen" />
        ...
        y: -10
            ...
            <MobileNavItem to="/admin/total-payouts" icon={<DollarSign className="w-4 h-4 mr-2" />} label="Gesamtauszahlungen" onClick={() => setIsOpen(false)} />
