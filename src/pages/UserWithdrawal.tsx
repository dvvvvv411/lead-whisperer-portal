...
import { ArrowLeft, CircleDollarSign, CreditCard, Wallet, TrendingUp } from "lucide-react";
      ...
      <div className="flex flex-col min-h-screen bg-casino-dark dark">
        ...
        <div className="container mx-auto px-4 py-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="backdrop-blur-sm bg-black/30 border-white/10 overflow-hidden h-full relative">
              <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full blur-xl"></div>
              <div className="p-6">
                <h2 className="text-xl font-semibold mb-4 flex items-center text-white">
                  <Wallet className="h-5 w-5 mr-2 text-white/70" />
                  <span>Auszahlungsoptionen</span>
                </h2>
                
                <div className="space-y-6 relative p-2">
                  {/* Animated floating elements */}
                  <div className="absolute top-10 left-4 w-16 h-16 bg-white/10 rounded-full blur-xl animate-float"></div>
                  <div className="absolute bottom-10 right-8 w-12 h-12 bg-white/10 rounded-full blur-xl animate-float" style={{animationDelay: "1s"}}></div>
                  
                  <div className="text-center mb-8">
                    <div className="flex justify-center py-6">
                      <Wallet className="h-24 w-24 text-white/40" />
                    </div>
                    <h3 className="text-xl font-medium text-white/90 mb-2">Schnelle und sichere Auszahlungen</h3>
                  ...
                  <div className="space-y-4 mt-8">
                    <div className="text-lg font-medium mb-2 flex items-center text-white">
                      <TrendingUp className="mr-2 h-5 w-5 text-white/70" />
                    ...
                    <div className="rounded-lg border border-white/20 p-4 bg-white/5">
                      <div className="flex items-center mb-2">
                        <div className="w-2 h-2 rounded-full bg-green-500/80 mr-2" />
                        <span className="text-white/90 font-medium">Niedrige Gebühren</span>
                      </div>
                    ...
                    <div className="rounded-lg border border-white/20 p-4 bg-white/5">
                      <div className="flex items-center mb-2">
                        <div className="w-2 h-2 rounded-full bg-green-500/80 mr-2" />
                        <span className="text-white/90 font-medium">Schnelle Abwicklung</span>
                      </div>
                      <p className="text-sm text-white/70 ml-4">
                    ...
                    <div className="rounded-lg border border-white/20 p-4 bg-white/5">
                      <div className="flex items-center mb-2">
                        <div className="w-2 h-2 rounded-full bg-green-500/80 mr-2" />
                        <span className="text-white/90 font-medium">Maximale Sicherheit</span>
                      </div>
                      <p className="text-sm text-white/70 ml-4">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <Card className="backdrop-blur-sm bg-black/30 border-white/10 overflow-hidden flex-1">
                <div className="flex flex-col h-full">
                  <div className="bg-black/40 p-4 border-b border-white/10 flex items-center">
                    <CreditCard className="h-5 w-5 mr-2 text-white/70" />
              ...
              <Card className="backdrop-blur-sm bg-black/30 border-white/10 p-6">
