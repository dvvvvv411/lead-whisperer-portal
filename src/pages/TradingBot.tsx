      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="p-6 bg-gradient-to-r from-gold/10 to-gold/5 rounded-lg border border-gold/20 shadow-lg">
            <h3 className="text-xl font-bold text-gold mb-4">Starten Sie noch heute mit automatisiertem Trading</h3>
            <p className="text-gray-300 mb-6">Maximieren Sie Ihre Gewinne mit unserer KI-Technologie - bis zu 30% monatliche Rendite möglich</p>
            <motion.button 
