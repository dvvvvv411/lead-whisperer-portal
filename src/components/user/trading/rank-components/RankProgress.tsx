...
const RankProgress = ({
  ...
  const progressToNextRank = nextTier ? Math.min(100, Math.round((userCredit - currentTier!.minBalance) / (nextTier.minBalance - currentTier!.minBalance) * 100)) : 100;
  if (!nextTier) return null;
  return <div className="mb-1 relative z-10 w-full max-w-[210px]">
      ...
      <Progress value={progressToNextRank} className="h-1.5 bg-casino-darker" indicatorClassName="bg-gradient-to-r from-accent1/70 to-accent1" />
